...
def main() -> None:
    ...
    # 4. Output Kotlin
    with open(repo_root / "java/src/com/hamp/inputmethod/latin/uix/settings/pages/credits/Contributors.kt", "w") as of:
        of.write("// Generated by tools/contributors.py, please do not update manually.\n")
        of.write("package com.hamp.inputmethod.latin.uix.settings.pages.credits\n")
        of.write("\n")
