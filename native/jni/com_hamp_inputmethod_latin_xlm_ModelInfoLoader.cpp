...
namespace latinime {
    ...
    jobject metadata_open(JNIEnv *env, jobject thiz, jstring pathString) {
        ...
        jclass modelInfoClass = env->FindClass("com/hamp/inputmethod/latin/xlm/ModelInfo");
    ...
    static const JNINativeMethod sMethods[] = {
            {
                    ...
                    const_cast<char *>("(Ljava/lang/String;)Lcom/hamp/inputmethod/latin/xlm/ModelInfo;"),
                    reinterpret_cast<void *>(metadata_open)
            },
    };

    int register_ModelInfoLoader(JNIEnv *env) {
        const char *const kClassPathName = "com/hamp/inputmethod/latin/xlm/ModelInfoLoader";
