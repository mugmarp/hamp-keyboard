...
import com.hamp.inputmethod.keyboard.KeyConsts
...
data class LayoutEngine(
    ...
    private fun computedKeyToKey(row: Int, col: Int, data: ComputedKeyData, x: Int, y: Int, width: Int, height: Int, leftGap: LayoutEntry.Gap?, rightGap: LayoutEntry.Gap?): com.hamp.inputmethod.keyboard.Key? {
        ...
        return com.hamp.inputmethod.keyboard.Key(
            code = data.code,
            label = data.label,
    ...
    fun build(): com.hamp.inputmethod.keyboard.Keyboard {
        ...
        return com.hamp.inputmethod.keyboard.Keyboard(params)
    }
}