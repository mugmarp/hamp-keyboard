...
import com.hamp.inputmethod.keyboard.internal.KeyboardLayoutElement
import com.hamp.inputmethod.keyboard.internal.KeyboardLayoutKind
import com.hamp.inputmethod.keyboard.internal.KeyboardLayoutPage
import com.hamp.inputmethod.keyboard.internal.KeyboardParams
import com.hamp.inputmethod.keyboard.internal.KeyboardTextsMultiSet
import com.hamp.inputmethod.latin.settings.LongPressKeySettings
import com.hamp.inputmethod.latin.uix.actions.BugInfo
import com.hamp.inputmethod.latin.uix.actions.BugViewerState
import com.hamp.inputmethod.latin.uix.settings.pages.CustomLayout
...
fun getPrimaryLayoutOverride(editorInfo: EditorInfo?): String? {
    return editorInfo?.getPrivateImeOptions()?.get("com.hamp.inputmethod.latin.ForceLayout")
}
...
class KeyboardLayoutSetV2 internal constructor(
    ...
    val forcedLayout = privateParams["com.hamp.inputmethod.latin.ForceLayout"]
    val forcedLocale = privateParams["com.hamp.inputmethod.latin.ForceLocale"]?.let { Locale.forLanguageTag(it) }
    val forcedMultilingualTypingLanguages: List<Locale>? = forcedLocale?.let { emptyList() }


    @OptIn(ExperimentalEncodingApi::class)
    val forcedCustomLayout = privateParams["com.hamp.inputmethod.latin.ForceCustomLayoutYamlB64"]?.let {
        try {
...
"""
    ...
    init {
        Log.d("KeyboardLayoutSet", "$forcedCustomLayout, ${privateParams["com.hamp.inputmethod.latin.ForceCustomLayoutYamlB64"]}, $privateParams, ${editorInfo.privateImeOptions}")
    }
    ...
    private fun safeGetLayout(name: String): com.hamp.inputmethod.v2keyboard.Keyboard =
        try {
...
"""
    ...
    private fun getSubKeyboard(element: KeyboardLayoutElement): com.hamp.inputmethod.v2keyboard.Keyboard? {
    ...
    private fun getKeyboardLayoutForElement(element: KeyboardLayoutElement): com.hamp.inputmethod.v2keyboard.Keyboard {
