...
import com.hamp.inputmethod.keyboard.internal.KeyboardState;
import com.hamp.inputmethod.keyboard.internal.KeyboardTextsSet;
import com.hamp.inputmethod.keyboard.internal.SwitchActions;
import com.hamp.inputmethod.latin.InputView;
import com.hamp.inputmethod.latin.LatinIME;
import com.hamp.inputmethod.latin.LatinIMELegacy;
import com.hamp.inputmethod.latin.R;
import com.hamp.inputmethod.latin.RichInputMethodManager;
import com.hamp.inputmethod.latin.RichInputMethodSubtype;
...
import com.hamp.inputmethod.latin.utils.ScriptUtils;
import com.hamp.inputmethod.v2keyboard.ComputedKeyboardSize;
import com.hamp.inputmethod.v2keyboard.KeyboardLayoutSetKt;
import com.hamp.inputmethod.v2keyboard.KeyboardLayoutSetV2;
import com.hamp.inputmethod.v2keyboard.KeyboardLayoutSetV2Params;
...
public final class KeyboardSwitcher implements SwitchActions {
    ...
    private int transformAutoCapsState(int state) {
        ...
        final com.hamp.inputmethod.v2keyboard.Keyboard keyboard = mKeyboardLayoutSet.getMainLayout();
