...
import static com.hamp.inputmethod.latin.common.Constants.ImeOption.NO_FLOATING_GESTURE_PREVIEW;
...
public final class InputAttributes {
    ...
    public InputAttributes(final EditorInfo editorInfo, final boolean isFullscreenMode,
        ...
        final boolean forceNoSuggestionsByPrivateFlag = editorInfo.privateImeOptions != null
                && editorInfo.privateImeOptions.contains("com.hamp.inputmethod.latin.NoSuggestions=1");
        ...
        if(privateImeOptions.containsKey("com.hamp.inputmethod.latin.ForceLocale")) {
            mLocaleOverride = Locale.forLanguageTag(Objects.requireNonNull(privateImeOptions.get("com.hamp.inputmethod.latin.ForceLocale")));
        } else {
            mLocaleOverride = null;
        }

        mLayoutOverride = privateImeOptions.get("com.hamp.inputmethod.latin.ForceLayout");
    }
