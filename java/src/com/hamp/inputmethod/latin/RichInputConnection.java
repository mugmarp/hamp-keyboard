...
import com.hamp.inputmethod.compat.InputConnectionCompatUtils;
import com.hamp.inputmethod.engine.InputMethodConnectionProvider;
import com.hamp.inputmethod.latin.common.Constants;
import com.hamp.inputmethod.latin.common.UnicodeSurrogate;
import com.hamp.inputmethod.latin.common.StringUtils;
import com.hamp.inputmethod.latin.inputlogic.InputLogic;
import com.hamp.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import com.hamp.inputmethod.latin.utils.CapsModeUtils;
import com.hamp.inputmethod.latin.utils.DebugLogUtils;
import com.hamp.inputmethod.latin.utils.NgramContextUtils;
import com.hamp.inputmethod.latin.utils.ScriptUtils;
import com.hamp.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.hamp.inputmethod.latin.common.Constants.UnicodeSurrogate
