...
import com.hamp.inputmethod.latin.common.ComposedData;
import com.hamp.inputmethod.latin.common.FileUtils;
import com.hamp.inputmethod.latin.define.DecoderSpecificConstants;
import com.hamp.inputmethod.latin.makedict.DictionaryHeader;
import com.hamp.inputmethod.latin.makedict.FormatSpec;
import com.hamp.inputmethod.latin.makedict.UnsupportedFormatException;
import com.hamp.inputmethod.latin.makedict.WordProperty;
...
import com.hamp.inputmethod.latin.utils.CombinedFormatUtils;
import com.hamp.inputmethod.latin.utils.ExecutorUtils;
import com.hamp.inputmethod.latin.utils.WordInputEventForPersonalization;
...
abstract public class ExpandableBinaryDictionary extends Dictionary {
    ...
    /**
     * Used by Sketch.
     * {@see https://cs.corp.google.com/#android/vendor/unbundled_google/packages/LatinIMEGoogle/tools/sketch/ime-simulator/src/com/hamp/inputmethod/sketch/imesimulator/ImeSimulator.java&q=updateEntriesForInputEventsCallback&l=286}
     */
    @UsedForTesting
