...
package com.hamp.inputmethod.latin.inputlogic;
...
import com.hamp.inputmethod.compat.SuggestionSpanUtils;
import com.hamp.inputmethod.engine.IMEHelper;
import com.hamp.inputmethod.engine.general.GeneralIME;
...
import com.hamp.inputmethod.latin.BinaryDictionary;
import com.hamp.inputmethod.latin.DictionaryFacilitator;
import com.hamp.inputmethod.latin.LastComposedWord;
import com.hamp.inputmethod.latin.NgramContext;
import com.hamp.inputmethod.latin.RichInputConnection;
import com.hamp.inputmethod.latin.Suggest;
import com.hamp.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import com.hamp.inputmethod.latin.SuggestedWords;
import com.hamp.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import com.hamp.inputmethod.latin.WordComposer;
...
import com.hamp.inputmethod.latin.settings.SettingsValuesForSuggestion;
import com.hamp.inputmethod.latin.settings.SpacingAndPunctuations;
import com.hamp.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import com.hamp.inputmethod.latin.uix.actions.BugViewerKt;
import com.hamp.inputmethod.latin.utils.InputTypeUtils;
import com.hamp.inputmethod.latin.utils.RecapitalizeStatus;
import com.hamp.inputmethod.latin.utils.StatsUtils;
import com.hamp.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link com.hamp.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
