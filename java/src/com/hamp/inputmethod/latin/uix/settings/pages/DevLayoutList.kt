                    ...
                    session.value = textInputService?.startInput(
                        ...
                        imeOptions = ImeOptions.Default.copy(
                            platformImeOptions = PlatformImeOptions(
                                privateImeOptions = "com.hamp.inputmethod.latin.NoSuggestions=1,com.hamp.inputmethod.latin.ForceLayout=$name,com.hamp.inputmethod.latin.ForceLocale=$language"
                            )
                        ),
                        onEditCommand = {
