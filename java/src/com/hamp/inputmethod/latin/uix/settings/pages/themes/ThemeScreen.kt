...
import com.hamp.inputmethod.latin.uix.settings.IMPORT_RESOURCE_FILE_REQUEST
import com.hamp.inputmethod.latin.uix.settings.RotatingChevronIcon
...
import com.hamp.inputmethod.latin.uix.theme.selector.ZipThemePreview
                ...
                session.value = service.startInput(
                    ...
                    imeOptions = ImeOptions.Default.copy(
                        platformImeOptions = PlatformImeOptions(
                            privateImeOptions = "com.hamp.inputmethod.latin.NoSuggestions=1"
                        )
                    ),
                    onEditCommand = { },
